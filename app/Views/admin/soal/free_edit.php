...
<div style="display: flex; flex-direction: column; gap: 20px;">
  ...
  <?php else: ?>
    ...
    <div class="card" style="padding: 14px 16px; background: #FFFFFF;">
    ...
    <div id="section-question-list">
      <div class="card" style="padding: 18px; border-radius: 12px; background: #FFFFFF; border: 1px solid var(--border-color);">
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 12px; flex-wrap: wrap; gap: 8px;">
          ...
          <button type="button" class="btn btn-primary btn-sm" onclick="openNewQuestionEditor()" style="font-weight: 700; height: 36px; padding: 0 16px; display: inline-flex; align-items: center; gap: 6px;">
        ...
        <div style="display: flex; flex-direction: column; gap: 8px;">
          <?php if (!empty($selectedPackage['questions'])): ?>
            ...
            <?php endforeach; ?>
          <?php else: ?>
            <p style="font-size: 12px; color: var(--text-muted); text-align: center; padding: 24px 0; background: #F8FAFC; border-radius: var(--radius-sm); border: 1px dashed var(--border-color);">
    ...
    <div id="section-question-editor" style="display: none; flex-direction: column; gap: 14px;">
      ...
      <!-- Top Action Bar -->
      <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 12px; background: #FFFFFF; border: 1px solid var(--border-color); border-radius: 12px; padding: 14px 18px; box-shadow: 0 1px 3px rgba(30, 34, 56, 0.04);">
        ...
        <div style="display: flex; align-items: center; gap: 8px;">
          ...
          <button type="button" onclick="document.getElementById('q-form').requestSubmit();" id="editor-top-submit-btn" class="btn btn-primary btn-sm" style="height: 38px; padding: 0 20px; font-weight: 700;">
            💾 Simpan Soal
          </button>
        </div>
      </div>
      ...
      <div class="card" style="padding: 22px; border-radius: 14px; background: #FFFFFF; border: 1px solid var(--border-color); box-shadow: 0 1px 4px rgba(30, 34, 56, 0.04);">
        <form id="q-form" action="<?= base_url("{$rolePrefix}/soal/save-question") ?>" method="post" enctype="multipart/form-data" style="display: flex; flex-direction: column; gap: 16px;">
          ...
          <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 14px; background: #F8FAFC; padding: 14px; border-radius: 10px; border: 1px solid #E2E8F0;">
            <!-- Kategori -->
            <div class="form-group">
          ...
          <div id="modal-pg-wrapper" style="display: flex; flex-direction: column; gap: 8px;">
            ...
            <?php foreach (['A', 'B', 'C', 'D', 'E'] as $opt): ?>
              <div style="display: flex; align-items: center; gap: 8px; background: #FFFFFF; padding: 6px 10px; border-radius: 8px; border: 1px solid var(--border-color);">
                <input type="radio" name="correct_option" id="radio-opt-<?= $opt ?>" value="<?= $opt ?>" <?= $opt === 'A' ? 'checked' : '' ?> title="Pilih sebagai Kunci Jawaban Benar" style="width: 18px; height: 18px; cursor: pointer; accent-color: var(--dark-navy);">
          ...
          <div style="display: flex; justify-content: flex-end; gap: 10px; margin-top: 8px; padding-top: 14px; border-top: 1px solid #E2E8F0;">
            ...
            <button type="submit" id="modal-submit-btn" class="btn btn-primary" style="width: auto; height: 42px; padding: 0 24px; font-weight: 700;">
              Simpan Soal
            </button>
          </div>
        </form>
...
function openNewQuestionEditor() {
  document.getElementById('q-editor-title').innerText = 'Tambah Butir Soal Baru';

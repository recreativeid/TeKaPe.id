          ...
          <div class="card" style="padding: 16px; display: flex; flex-direction: column; gap: 8px; border-color: #FDE68A;">
            ...
            <div style="display: flex; align-items: center; justify-content: space-between; border-top: 1px solid var(--border-light); padding-top: 10px; margin-top: 4px;">
              <div style="font-size: 12px; color: var(--text-muted);">
                ...
                <strong style="color: var(--warm-amber);">Rp <?= number_format($pkg['price'], 0, ',', '.') ?></strong>
              </div>
      ...
      <form action="<?= base_url("admin/soal/updatePackage/{$selectedPackage['id']}") ?>" method="post" style="display: flex; flex-direction: column; gap: 12px; margin-top: 6px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 10px;">
          <div class="form-group">
            ...
            <input type="number" name="price" class="form-control" value="<?= esc($selectedPackage['price']) ?>">
          </div>
          <div class="form-group">
            <label class="form-label">Durasi (Hari)</label>
            <input type="number" name="duration_days" class="form-control" value="<?= esc($selectedPackage['duration_days']) ?>">
          </div>
        </div>
